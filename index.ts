    ...
    while(true){
        try{
            ...
            if(gpsData !== null){
                ...
                Database.setVehiclePosition(position)
                ...
                if(lastPosition !== undefined){
                    ...
                    vehicle.mileage = Number((vehicle.mileage + haversineDistance(lastPosition.latitude, lastPosition.longitude, position.latitude, position.longitude)).toFixed(3))
